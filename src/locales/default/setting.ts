...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.wizard.step2.billing.cycleLabel': 'Billing cycle',
  'workspace.wizard.step2.billing.freeSummary': 'Solo workspace · no payment required',
  'workspace.wizard.step2.billing.planLine': '{{plan}} · {{cycle}}',
  'workspace.wizard.step2.billing.seatsLine': '{{count}} seat(s)',
  'workspace.wizard.step2.billing.summary': 'Buy {{plan}} · {{cycle}}',
  ...
  'workspace.wizard.step2.billing.totalYearHint': 'Billed once yearly · cancel anytime',
  ...
  'workspace.wizard.step2.features.collaboration.desc':
    'Invite teammates and share agents, sessions, and files in one place.',
  'workspace.wizard.step2.features.collaboration.title': 'Team collaboration',
  'workspace.wizard.step2.features.priorityModels.desc':
    'Priority access to premium models with higher rate limits for your whole team.',
  'workspace.wizard.step2.features.priorityModels.title': 'Priority model access',
  'workspace.wizard.step2.left.freeHeadline': 'Spin up a solo workspace',
  'workspace.wizard.step2.left.freeTagline':
  ...
  'workspace.wizard.step2.subtitle':
    'Each workspace is billed separately. Pick a plan to finish setup.',
