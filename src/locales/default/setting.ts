...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tab.workspaceGeneral': 'General',
  'tab.workspaceMembers': 'Members',
  ...
  'workspace.general.leave.personalHint': 'Personal workspaces cannot be left.',
  ...
  'workspace.general.url.invalid': 'Only lowercase letters, numbers and dashes are allowed.',
  'workspace.general.url.prefix': 'lobehub.com/',
  ...
  'workspace.member.remove': 'Remove',
  'workspace.member.removeConfirm.content': 'This member will lose access immediately.',
  'workspace.member.removeConfirm.title': 'Remove this member?',
  'workspace.member.roles.admin': 'Admin',
  'workspace.member.roles.editor': 'Editor',
  ...
  'workspace.members.invite.success': 'Invitation link copied to clipboard',
  ...
  'workspace.wizard.step1.slug.invalid': 'Only lowercase letters, numbers and dashes are allowed.',
  'workspace.wizard.step1.slug.label': 'Workspace URL',
  'workspace.wizard.step1.slug.placeholder': 'acme-team',
  'workspace.wizard.step1.slug.prefix': 'lobehub.com/',
  'workspace.wizard.step1.subtitle': 'Give your workspace a name and URL.',
  'workspace.wizard.step1.title': 'Workspace details',
  'workspace.wizard.step2.benefits.adminControls':
    'Centralized billing, role management, and audit logs',
  'workspace.wizard.step2.benefits.collaboration':
    'Invite teammates and share agents, sessions, files',
  'workspace.wizard.step2.benefits.priorityModels':
    'Priority access to premium models and higher rate limits',
  'workspace.wizard.step2.benefits.usageAnalytics':
    'Track team usage and optimize your subscription',
  'workspace.wizard.step2.continue': 'Continue',
  'workspace.wizard.step2.createFailed': 'Failed to create workspace',
  'workspace.wizard.step2.freeWarning.desc':
    'The Free plan cannot invite collaborators. Upgrade to Premium or higher to continue.',
  'workspace.wizard.step2.freeWarning.title': 'Upgrade required to invite members',
  'workspace.wizard.step2.payFailed': 'Failed to start checkout',
  'workspace.wizard.step2.qualified.desc':
    'Your {{plan}} plan unlocks team collaboration. Click continue to finish setup.',
  'workspace.wizard.step2.qualified.title': "You're ready to create a team workspace",
  'workspace.wizard.step2.subtitle':
    'A team workspace requires a Premium or higher plan to invite collaborators.',
  'workspace.wizard.step2.title': 'Choose your plan',
  'workspace.wizard.step2.upgradeTo': 'Upgrade to {{plan}}',
