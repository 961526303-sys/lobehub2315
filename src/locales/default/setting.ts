...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.invite.title': 'Invite Member',
  ...
  'workspace.upgrade.createTeam': 'Create team',
  'workspace.upgrade.enterprise.cta': 'Contact sales',
  'workspace.upgrade.enterprise.desc':
    'Get pooled usage, SCIM seat management, and granular admin controls',
  'workspace.upgrade.enterprise.title': 'Need enterprise features?',
  'workspace.upgrade.features.adminControls.desc': 'Centralized billing and privacy mode controls',
  'workspace.upgrade.features.adminControls.title': 'Admin Controls',
  'workspace.upgrade.features.rulesCommands.desc': 'Share rules and commands across your team',
  'workspace.upgrade.features.rulesCommands.title': 'Rules & Commands',
  'workspace.upgrade.features.teamManagement.desc':
    'Invite members, manage roles, and control access',
  'workspace.upgrade.features.teamManagement.title': 'Team Management',
  'workspace.upgrade.features.usageAnalytics.desc':
    'Track team usage and optimize your subscription',
  'workspace.upgrade.features.usageAnalytics.title': 'Usage Analytics',
  'workspace.upgrade.modal.billing': 'Billing cycle',
  'workspace.upgrade.modal.hint':
    "You'll keep all your existing agents, sessions, and files — only collaboration is unlocked.",
  'workspace.upgrade.modal.monthly': 'Monthly',
  'workspace.upgrade.modal.namePlaceholder': 'e.g. Acme Team',
  'workspace.upgrade.modal.seats': 'Seats',
  'workspace.upgrade.modal.submit': 'Upgrade',
  'workspace.upgrade.modal.title': 'Upgrade to Team',
  'workspace.upgrade.modal.yearly': 'Yearly',
  'workspace.upgrade.subtitle': 'Work with your team and unlock collaborative features',
  'workspace.upgrade.title': 'Upgrade to Team',
  'tools.add': 'Add Skill',
