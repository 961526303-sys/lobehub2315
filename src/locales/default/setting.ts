...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.wizard.step2.pay': 'Continue to payment',
  'workspace.wizard.step2.plan.recommended': 'Recommended',
  'workspace.wizard.step2.plan.team': 'Team',
  'workspace.wizard.step2.recurring.label': 'Billing cycle',
  'workspace.wizard.step2.recurring.monthShort': 'mo',
  'workspace.wizard.step2.recurring.monthly': 'Monthly · ${{price}} / seat',
  'workspace.wizard.step2.recurring.yearShort': 'yr',
  'workspace.wizard.step2.recurring.yearly': 'Yearly · ${{price}} / seat',
  'workspace.wizard.step2.seats.hint': 'Between {{min}} and {{max}} seats.',
  'workspace.wizard.step2.seats.label': 'Seats',
  'workspace.wizard.step2.subtitle': 'Pick a billing cycle and team size to continue.',
  'workspace.wizard.step2.title': 'Choose your plan',
  'workspace.wizard.step2.total.detail': '{{seats}} seats × ${{price}} / seat / {{cycle}}',
  'workspace.wizard.step2.total.label': 'Total due today',
  ...
  'workspace.wizard.step3.modalTitle': 'Who else is on your team?',
  ...
  'workspace.wizard.step3.titleFallback': 'Welcome to your new workspace!',
  'workspace.wizard.steps.info': 'Workspace',
  'workspace.wizard.steps.plan': 'Plan & payment',
